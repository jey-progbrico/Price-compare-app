...
export async function scrapeBricoman(query: string): Promise<ScraperResult> {
  const result: ScraperResult = {
    enseigne: "Bricoman",
    titre: "",
    prix: null,
    lien: `https://www.bricoman.fr/recherche?q=${encodeURIComponent(query)}`,
    statut: "error"
  };
